        ...
        this.display = function(data) {
            ...
            if (this.options.display_gallery) {
                ...
                if (typeof data.is_private !== "undefined" && data.is_private === true) {
                    ...
                    html += "<a href='https://www.instagram.com/grosbasketshop/' target='_blank'><span class='ig-profile'><img src='https://www.grosbasket.com/skin/frontend/ultimo/v2/images/icons/social/Instagram/White.svg' class='uk-position-center' uk-svg></span></a>";
                    for (var i = 0; i < max; i++) {
